...
-- We have to scale it down because acf is scaled down. It's also short-range due to AAM guidelines.
...
ACF_defineGun("AIM-120 AAM", { --id
	...
	viewcones		= 20, -- getting outside this cone will break the lock. Divided by 2.	--was 25
