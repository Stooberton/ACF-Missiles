...
ACF_defineGun("Type 63 RA", { --id
	...
	racks		= {RK_1xRack_Small = true, RK_1xRack = true, RK_2xRack = true, RK_3xRack = true, RK_4xRack = true, POD_6xUARRK = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
