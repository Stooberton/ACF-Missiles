...
ACF_defineGun("50kgBOMB", { --id
	...
	gunclass		= "BOMB",
	rack			= "RK_3xRack", -- Which rack to spawn this missile on?
	length			= 5,
	caliber			= 5.0,
	...
	racks			= {RK_1xRack_Small = true, RK_1xRack = true, RK_2xRack = true, RK_3xRack = true, RK_4xRack = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("1000kgBOMB", { --id
	...
	guidance		= {"Dumb"},
	fuses			= {"Contact", "Optical", "Cluster"},
	racks			= {RK_1xRack = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("250kgGBOMB", { --id
	...
	guidance		= {"Dumb"},
	fuses			= {"Contact", "Optical", "Cluster"},
	racks			= {RK_1xRack = true, RK_2xRack = true, RK_3xRack = true, RK_4xRack = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
