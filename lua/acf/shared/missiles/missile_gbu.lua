...
ACF_defineGun("WalleyeGBU", { --id
	...
	racks			= {RK_1xRack = true,	RK_2xRack = true, RK_3xRack = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
