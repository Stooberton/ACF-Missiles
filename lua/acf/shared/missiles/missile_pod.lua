...
ACF_defineGun("40mmFFAR", { --id
	...
	caliber		= 4,
	gunclass	= "FFAR",
	rack		= "POD_7x40mm", -- Which rack to spawn this missile on?
	weight		= 6,
	...
	guidance	= {"Dumb"},
	fuses		= {"Contact", "Timed"},
	racks		= {POD_7x40mm = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("70mmFFAR", { --id
	...
	caliber		= 7,
	gunclass	= "FFAR",
	rack		= "POD_7x70mm", -- Which rack to spawn this missile on?
	weight		= 12,
	length		= 15,
	year		= 1960,
	rofmod		= 0.6,
	...
	guidance	= {"Dumb"},
	fuses		= {"Contact", "Timed"},
	racks		= {POD_7x70mm = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
