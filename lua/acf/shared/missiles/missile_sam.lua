...
ACF_defineGun("FIM-92 SAM", { --id
	...
	gunclass		= "SAM",
	rack			= "POD_1xStinger", -- Which rack to spawn this missile on?
	length			= 66,
	caliber			= 7,
	...
	guidance		= {"Dumb", "Radar"},
	fuses			= {"Contact", "Radio"},
	racks			= {POD_1xStinger = true, POD_2xStinger = true, POD_4xStinger = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("Strela-1 SAM", { --id
	...
	gunclass		= "SAM",
	rack			= "POD_1xStrela", -- Which rack to spawn this missile on?
	length			= 60,
	caliber			= 8.0,
	...
	guidance		= {"Dumb", "Radar"},
	fuses			= {"Contact", "Radio"},
	racks			= {POD_1xStrela = true, POD_2xStrela = true, POD_4xStrela = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("SIMBAD SAM", { --id
	name			= "Simbad Defense System",
	...
	model			= "models/missiles/fim_92.mdl",
	gunclass		= "SAM",
	rack			= "POD_2xStinger", -- Which rack to spawn this missile on?
	length			= 74.4,
	caliber			= 7,
	weight			= 19.7, -- Don't scale down the weight though!
	modeldiameter	= 6.6, -- in cm
	year			= 1988,
	ent				= "acf_rack", -- Entity where this missile/bomb will be spawned
	seekcone		= 5, -- getting inside this cone will get you locked. Divided by 2 ('seekcone = 40' means 80 degrees total.)
	viewcone		= 38, -- getting outside this cone will break the lock. Divided by 2.	--was 55
	agility			= 5, -- multiplier for missile turn-rate.		--was 1
	armdelay		= 0.1, -- minimum fuse arming delay		-was 0.3
	guidance		= {"Dumb", "Antimissile"},
	fuses			= {"Contact", "Radio"},
	racks			= {POD_2xStinger = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
	...
	round = {
		...
		minspeed		= 2500,		-- minimum speed beyond which the fins work at 100% efficiency
