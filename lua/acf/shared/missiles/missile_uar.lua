...
ACF_defineGun("RS82 ASR", { --id
	...
	caliber		= 8,
	gunclass	= "UAR",
	rack		= "RK_1xRack_Small", -- Which rack to spawn this missile on?
	weight		= 5,
	length		= 40,
	year		= 1933,
	rofmod		= 0.6,
	...
	guidance	= {"Dumb"},
	fuses		= {"Contact", "Timed"},
	racks		= {RK_1xRack_Small = true, RK_2xRack = true, RK_3xRack = true, RK_4xRack = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("HVAR ASR", { --id
	...
	guidance	= {"Dumb"},
	fuses		= {"Contact", "Timed"},
	racks		= {RK_1xRack = true, RK_1xRack_Small = true, POD_3xUARRK = true, RK_2xRack = true, RK_3xRack = true, RK_4xRack = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("SPG-9 ASR", { --id
	...
	caliber		= 7.3,
	gunclass	= "UAR",
	rack		= "POD_1xSPG9", -- Which rack to spawn this missile on?
	weight		= 40,
	length		= 20,
	year		= 1962,
	rofmod		= 0.75,
	...
	racks		= {POD_1xSPG9 = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("S-24 ASR", { --id
	...
	guidance	= {"Dumb"},
	fuses		= {"Contact", "Timed"},
	racks		= {RK_1xRack = true, RK_3xRack = true, RK_2xRack = true, POD_6xUARRK = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
...
ACF_defineGun("Zuni ASR", { --id
	...
	racks		= {RK_1xRack = true, RK_2xRack = true, RK_3xRack = true, RK_4xRack = true, POD_4xZuni = true},
...
ACF_defineGun("RW61 ASR", { --id
	...
	caliber		= 38,
	gunclass	= "UAR",
	rack		= "POD_RW61", -- Which rack to spawn this missile on?
	weight		= 1500,
	length		= 38,
	year		= 1960,
	rofmod		= 0.9,
	...
	guidance	= {"Dumb"},
	fuses		= {"Contact", "Optical"},
	racks		= {POD_RW61 = true}, -- a whitelist for racks that this missile can load into. can also be a 'function(bulletData, rackEntity) return boolean end'
