...
function ACFM_CreateConfigurable(str, configurables, bdata, wlistPath)
	-- we're eating arbitrary user input, so let's not fuck up if they fuck up
	success, ret = xpcall(function() return ACFM_CreateConfigurable_Raw(str, configurables, bdata, wlistPath) end, ErrorNoHalt)
